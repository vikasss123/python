...
class travel:
    ...
    #==========================================Define Functiom==================================================
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "MAIN GATE":
                    switch ={"MAIN GATE": 10,"UNI CENTER": 8,"ADMISSION BLOCK":6,"LPU PLAYGROUND": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "UNI CENTER":
                    switch ={"MAIN GATE": 0,"UNI CENTER": 2,"ADMISSION BLOCK":5,"LPU PLAYGROUND": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "ADMISSION BLOCK":
                    switch ={"MAIN GATE": 2,"UNI CENTER": 0,"ADMISSION BLOCK":3,"LPU PLAYGROUND": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "LPU PLAYGROUND":
                    switch ={"MAIN GATE": 5,"UNI CENTER": 3,"ADMISSION BLOCK":0,"LPU PLAYGROUND": 6}
                    Km.set(switch[varl2.get()])        
   ...
   #================================================mainframe========================================================================
    ...
    #===============================================Cab Information==============================================================
        ...
        self.cboPickup['value']=('','MAIN GATE','UNI CENTER','ADMISSION BLOCK','LPU PLAYGROUND')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','MAIN GATE','UNI CENTER','ADMISSION BLOCK','LPU PLAYGROUND')
        self.cboDrop.current(0)
